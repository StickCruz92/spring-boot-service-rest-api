...
public class SocialMediaController {
	...
	public ResponseEntity<SocialMedia> getSocialMediasById(@PathVariable("id") Long idSocialMedia){
		...
		if (idSocialMedia == null || idSocialMedia <= 0) {
				return new ResponseEntity(new CustomErrorType("idSocialMedia is requered"),  HttpStatus.CONFLICT);
	     }
	...
	public ResponseEntity<?> createSocialMedia(@RequestBody SocialMedia socialMedia,
		...
		if (socialMedia.getName().equals(null) || socialMedia.getName().isEmpty()) {
			return new ResponseEntity(new CustomErrorType("SocialMedia name is requered"),  HttpStatus.CONFLICT);
		}
